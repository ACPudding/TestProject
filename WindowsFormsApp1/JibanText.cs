...
namespace FGOServantBasicInformationAnalyzer
{
    public partial class JibanText : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            DirectoryInfo outputdir = new DirectoryInfo(path + @"\Output\");
            string output = "";
            ...
            MessageBox.Show("导出完成.\n\r文件名为: " + outputdir.FullName + "羁绊文本_" + SkillLvs.svtid + "_" + SkillLvs.svtnme + ".txt", "Success", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
    }
}
